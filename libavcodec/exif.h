...
/**
 * Retrieves the tag name associated with the specific tag ID.
 *
...
/**
 * Retrieves the tag ID associated with the specific tag string name.
 *
 * For example, av_exif_get_tag_id("Orientation") returns 0x112.
 */
